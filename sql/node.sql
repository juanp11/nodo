...
-- Tiempo de generación: 26-08-2020 a las 22:18:01
...
INSERT INTO `ciudades` (`id`, `ciudad`, `estado`, `departamento_id`) VALUES
(1, 'Abriaquí', 1, 5),
(2, 'Acacías', 1, 50),
(3, 'Acandí', 1, 27),
(4, 'Acevedo', 1, 41),
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  `status` varchar(50) NOT NULL DEFAULT 'En Confirmacion',
  `fecha` datetime NOT NULL,
  `pesocaja` int(1) NOT NULL,
  `valorasegurado` varchar(8) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `departamento_id` (`departamento_id`),
...
--
-- Estructura de tabla para la tabla `pesocaja`
--

DROP TABLE IF EXISTS `pesocaja`;
CREATE TABLE IF NOT EXISTS `pesocaja` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `pesocaja`
--

INSERT INTO `pesocaja` (`id`, `peso`) VALUES
(1, '1 Kilo'),
(2, '2 Kilos'),
(3, '3 Kilos');
...
--
-- Estructura de tabla para la tabla `valorasegurado`
--

DROP TABLE IF EXISTS `valorasegurado`;
CREATE TABLE IF NOT EXISTS `valorasegurado` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `valorasegurado`
--

INSERT INTO `valorasegurado` (`id`, `valor`) VALUES
(1, '$ 10.000'),
(2, '$ 20.000'),
(3, '$ 30.000'),
(4, '$ 40.000'),
...
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id`),
